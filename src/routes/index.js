...
router.get   ('/conciliacion',                 autenticar, conciliacion.listar);
router.get   ('/conciliacion/resumen',         autenticar, conciliacion.resumen);
router.post  ('/conciliacion',                 autenticar, autorizar('admin','operador'), conciliacion.crear);
router.put   ('/conciliacion/:id',             autenticar, autorizar('admin','operador'), conciliacion.actualizar);
router.delete('/conciliacion/:id',             autenticar, autorizar('admin'), conciliacion.eliminar);
